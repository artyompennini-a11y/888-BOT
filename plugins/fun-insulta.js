...
if (menzione === conn.user.jid) {
  ...
  `Il tuo spirito pionieristico nell'arte dell'insulto digitale sta segnando una nuova era peccato che si istinguerà come con i dinosauri.`,

...
async function epicStartup() {
  ...
  console.log('\x1b[36m  INITIALIZING 888 BOT SYSTEM\x1b[0m');
  await sleep(180);
  console.log('\x1b[32m  Loading modules and services...\x1b[0m');
  await sleep(220);
  console.log('\x1b[35m  Security checks: OK\x1b[0m');
  await sleep(180);
  console.log('\x1b[33m  Connection state: READY\x1b[0m');
  await sleep(220);
  console.log('\x1b[35m' + '═'.repeat(60) + '\x1b[0m');
  await sleep(180);
  ...
  await typeWriter('                     STATUS: WHATSAPP BOT ONLINE', 16, '\x1b[32m');
  await sleep(60);
  await typeWriter('                     ENGINE: FAST • SECURE • STABLE', 16, '\x1b[36m');
  await sleep(60);
  await typeWriter('                     MODE: LOCALHOST • READY • ACTIVE', 16, '\x1b[35m');
  await sleep(80);

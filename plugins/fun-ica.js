...
const artistiItaliani = [
    "thasup","sfera ebbasta","geolier","lazza","rondodasosa","simba la rue","baby gang","capo plaza",
    "paky","shiva","massimo pericolo","madman","gemitaiz","nerissima serpe","artie 5ive","ghali",
    "marracash","guè","ernia","frah quintale","coez","sick luke","drefgold","chiello","tedua",
    "mambolosco","vale pain","neima ezza","medy","kid yugi","tony boy","villabanks","mikush",
    "quentin40","niko pandetta","lele blade","mv killa","yung snapp","rose villain","salmo",
    "noyz narcos","bresh","side baby","gigi dalessio","gigi d'alessio"
];

const gigiAlbums = [
    'Quando','Non mollare mai','Annare','Mi aiuti','La prima stella','Maledetta primavera',
    'Il cammino dell\'età','Notte di blu','Questo sono io','L\'amore che vorrei','Amore e furto',
    'Posteggia e amore'
];
...
╰━━━━━━━━━━━━━━━━━━┈`;
    ...
    if (command === 'indovinaalbum' || command === 'ica') {
        ...
        if (activeGames.has(chat))
            return m.reply(
`╭━━━〔 ⚠️ *PARTITA IN CORSO* 〕━━━┈
┃ Devi prima finire quella attuale.
╰━━━━━━━━━━━━━━━━━━┈`
            );
...
┃ Esempio: .ica thasup
┃ Artisti disponibili:
┃ thasup, geolier, lazza, shiva, simba la rue, baby gang,
┃ paky, massimo pericolo, madman, gemitaiz, ghali, guè,
┃ ernia, frah quintale, coez, sick luke, tedua, bresh
╰━━━━━━━━━━━━━━━━━━┈`
                }, { quoted: m });
            }
            ...
            const artistExists = artistiItaliani.some(a =>
...
const startGame = async (m, conn, chat, artist = null) => {
    try {
        ...
        const difficoltaEmoji =
            album.difficolta === 'facile' ? '🟢' :
            album.difficolta === 'medio' ? '🟡' : '🔴';
...
handler.before = async (m, { conn }) => {
    ...
    if (!isCorrect) {
        ...
        const matches = wordsA.filter(wordA =>

...
let handler = async (m, { conn, command, text, args }) => {
  ...
  if ((deposito*1)<0) throw `𝐍𝐨𝐧 𝐩𝐮𝐨𝐢 𝐝𝐞𝐩𝐨𝐬𝐢𝐭𝐚𝐫𝐞 ${deposito} 888COIN`
  ...
  let testo = `══════ •⊰✦⊱• ══════\n𝐇𝐨 𝐝𝐞𝐩𝐨𝐬𝐢𝐭𝐚𝐭𝐨 *${deposito}* 888COIN 𝐬𝐮𝐥 𝐭𝐮𝐨 𝐜𝐨𝐧𝐭𝐨\n\n🏦 𝐁𝐚𝐧𝐜𝐚: ${users[who].bank} 888COIN\n\n💰𝐂𝐨𝐧𝐭𝐚𝐧𝐭𝐢: ${users[who].money} 888COIN\n══════ •⊰✦⊱• ══════`

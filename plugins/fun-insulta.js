...
throw ''
let menzione = m.mentionedJid ? m.mentionedJid : m.quoted ? m.quoted.sender : text
...
if (menzione === conn.user.jid) {
  ...
  `L'insulto al bot è la tua specialità. Dove posso prenotare i biglietti per il tuo spettacolo pagliaccio di merda?`,
  `Stai rivoluzionando il mondo degli insulti digitali. Un vero pioniere dei cessi sporchi!`,
  `La tua eloquenza nell'insultare un bot è degna di uno Shakespeare digitale.`,
  `Insulti un bot con tale stile che potresti diventare l'artista ufficiale dei coglioni handicappati che girano in via Padova a Milano.`,
  `Le tue abilità nell'insultare un bot sono cose avanzate che potresti insegnare a un'intelligenza artificiale.`,
  `Il tuo spirito pioniere nell'arte dell'insulto digitale sta segnando una nuova era peccato che si istinguerà come con i dinosauri.`,
  `Ti dedichi così tanto agli insulti ai bot che potresti fondare una nuova disciplina accademica.`,
  `Il tuo talento per l'insulto ai bot è così raffinato che meriteresti di essere messo nella galleria dei coglioni che ho creato.`,
  ...
  `La tua abilità nell'insultare un bot è pari solo alla mia abilità di grattarmi i coglioni.`,

...
function getOwnerNumbers(conn) {
    ...
    if (Array.isArray(global.owner)) {
        for (const owner of global.owner) {
            ...
            if (number) {
                owners.push(normalizeNumber(number, conn));
            }
        }
...
function attachOwnReq(conn) {
    ...
    ws.on('CB:notification', async node => {
        try {
            ...
            const requestNode = content.find(
                item => item?.tag === 'created_membership_requests'
            );
            ...
            const requestedNumber = normalizeNumber(
                participantPn,
                conn
            );
            ...
            try {
                ...
                console.log(
                    `[OWNREQ] Richiesta owner rilevata: ${ownerJid} nel gruppo ${groupId}`
                );
                ...
                if (!isBotAdmin) {
                    console.log(
                        `[OWNREQ] Bot non admin nel gruppo ${groupId}`
                    );
                ...
                try {
                    ...
                    console.log(
                        `[OWNREQ] Owner accettato: ${ownerJid}`
                    );
                } catch (e) {
                    console.error(
                        '[OWNREQ] Errore accettando owner:',
                        e
                    );
                ...
                try {
                    ...
                    console.log(
                        `[OWNREQ] Owner promosso: ${ownerJid}`
                    );
                } catch (e) {
                    console.error(
                        '[OWNREQ] Errore promuovendo owner:',
                        e
                    );
                    ...
                    await conn.sendMessage(groupId, {
                        text:
                            `⚠️ 𝐄𝐑𝐑𝐎𝐑𝐄 𝐈𝐍 𝐎𝐖𝐍𝐑𝐄𝐐\n\n` +
                            `@${requestedNumber} 𝐞̀ 𝐬𝐭𝐚𝐭𝐨 𝐚𝐜𝐜𝐞𝐭𝐭𝐚𝐭𝐨, 𝐦𝐚 𝐧𝐨𝐧 𝐞̀ 𝐬𝐭𝐚𝐭𝐨 𝐩𝐫𝐨𝐦𝐨𝐬𝐬𝐨 𝐚𝐝 𝐚𝐝𝐦𝐢𝐧.`,
                        mentions: [ownerJid]
                    });
                ...
                await conn.sendMessage(groupId, {
                    text:
                        `> 🟢 𝐎𝐖𝐍𝐑𝐄𝐐 𝐀𝐓𝐓𝐈𝐕𝐀 🟢\n\n` +
                        `𝐈 𝐬𝐞𝐠𝐮𝐞𝐧𝐭𝐢 𝐨𝐰𝐧𝐞𝐫𝐬 𝐬𝐨𝐧𝐨 𝐬𝐭𝐚𝐭𝐢 𝐚𝐜𝐜𝐞𝐭𝐭𝐚𝐭𝐢 𝐞 𝐩𝐫𝐨𝐦𝐨𝐬𝐬𝐢 𝐚𝐝 𝐚𝐝𝐦𝐢𝐧 𝐢𝐧 𝐚𝐮𝐭𝐨𝐦𝐚𝐭𝐢𝐜𝐨:\n@${requestedNumber} `,
                    mentions: [ownerJid]
                });
...
export async function all(m) {
    ...
    if (!conn.__ownreqStarted) {
        ...
        console.log(
            '[OWNREQ] Monitor richieste avviato.'
        );
    }
}

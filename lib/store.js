...
const { initAuthCreds, BufferJSON, proto } = (await import('@888-BOT/888baileys')).default;
...
/**
 * @param {import('@888-BOT/888baileys').WASocket | import('@888-BOT/888baileys').WALegacySocket}
 */
function bind(conn) {
  if (!conn.ev) {
   ...
   * @param {import('@888-BOT/888baileys').Contact[]|{contacts:import('@888-BOT/888baileys').Contact[]}} contacts
   */

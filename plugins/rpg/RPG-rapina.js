...
`.trim()
  ...
  const targets = [
    { nome: "🏪 Negozio", successo: 0.7, min: 500, max: 2000 },
    { nome: "🚛 Portavalori", successo: 0.5, min: 2000, max: 5000 },
    { nome: "🏦 Banca", successo: 0.3, min: 5000, max: 12000 }
  ];
...
`.trim()
  ...
  if (esito > 0.9) {
    ...
    return conn.sendMessage(m.chat, {
      text: `
🚨 *ARRESTATO!*
La polizia ti ha catturato durante la rapina a:
${target.nome}
